...
def random_jitter(input_image, real_image):
  ...
  input_image, real_image = resize(input_image, real_image, round(IMG_HEIGHT*1.1), round(IMG_WIDTH*1.1))
...
test_dataset = tf.data.Dataset.list_files(PATH+'test/*.jpg')  #'test/*.jpg')
...
def Generator():
  inputs = tf.keras.layers.Input(shape=[256,256,3])#IMG_HEIGHT,IMG_WIDTH,4])
